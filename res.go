...
Установи пожалуйста автоудаление сообщений в этом чате на 1 день, если на твоем клиенте это возможно. [Инструкция](https://telegram.org/blog/autodelete-inv2/ru?ln=a)`
    ...
    Последний, но важный шаг. У меня есть для тебя твое имя и 6 слов - их я дам. 
	Их нужно где-то хранить - места для хранения я не дам. 
	Спрячь эти слова туда, куда ты сможешь добраться в любой непонятной ситуации, 
	но не доберется трщ майор. Нет, не туда! Туда доберется :( 
	Лучше - в харнилку паролей или еще какое-нибудь хитрое место.`
