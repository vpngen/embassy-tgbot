...
require (
	...
	github.com/vpngen/keydesk v1.5.4
	github.com/vpngen/ministry v1.4.0
...
require (
	...
	github.com/vpngen/dc-mgmt v1.5.3 // indirect
	github.com/vpngen/keydesk-snap v0.0.13 // indirect
	github.com/vpngen/vpngine v0.1.0 // indirect
