...
type Update struct {
	...
	// MessageReaction is a reaction to a message was changed by a user. The bot must
	// be an administrator in the chat and must explicitly specify "message_reaction"
